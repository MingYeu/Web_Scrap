...
# layout3= [[sg.Text('Category', size=(10,1)),sg.Input('',key='eCategoryColLink')],
#            [sg.Text('Link', size=(10,1)),sg.Input('',key='eJFdt')],
#           [sg.Button('Start Collect')]]
...
tabgrp = [[sg.TabGroup([[sg.Tab('Analysis Report', layout1, title_color='Black',border_width =10, background_color='white', element_justification= 'center'),
                         sg.Tab('Collect Key', layout2,title_color='Black',background_color='white', element_justification= 'center'),
                         sg.Tab('Add Existing Category', layout3,title_color='Black',background_color='white', element_justification= 'center'),
...
#Define Window
window =sg.Window("Business Analysis",tabgrp)
...
while True:          
    ...
    if event == 'Save Analysis':
        ...
        if (values['exist_cat_new_key']).lower() in check_file_exist:
            ...
            search_all_product(str(values['board_add_exist']), str(values['new_key']))
